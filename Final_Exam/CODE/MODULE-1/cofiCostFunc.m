function [J, grad] = cofiCostFunc(params, Y, R, num_users, Number_skills, ...
                                  num_features, lambda)

% Unfold the U and W matrices from params
X = reshape(params(1:Number_skills*num_features), Number_skills, num_features);
Theta = reshape(params(Number_skills*num_features+1:end), ...
